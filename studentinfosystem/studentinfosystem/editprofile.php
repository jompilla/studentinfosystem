      ...
      <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
        ...
        <div class="form-group">
          ...
          <select class="form-control" name="course">
              <option value="BSF" <?php echo $course == 'BSF' ? "selected": ""; ?>>Forestry</option>
              <option value="BSC" <?php echo $course == 'BSC' ? "selected": ""; ?>>CRIMINOLGY</option>
              <option value="BSIT" <?php echo $course == 'BSIT' ? "selected": ""; ?>>Information Technology</option>
              <option value="BSA" <?php echo $course == 'BSA' ? "selected": ""; ?>>Agriculture</option>
              <option value="BSCE" <?php echo $course == 'BSCE' ? "selected": ""; ?>>Engineering</option>
